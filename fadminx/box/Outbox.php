...
?>
<div id="toubu"><span class="tbbiaoti"><strong>发件箱</strong></span></div><br>
...
$count=$db->query("select count(*) from message where senduid='admin'  {$sqladd}"); //获得记录总数
...
$result=$db->query("select * from message where senduid='admin' {$sqladd} limit $startCount,$perNumber"); //根据前面的计算出开始的记录和记录数
?>
<?php
