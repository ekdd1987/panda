        ...
        <table width="900" border="0" align="center" cellpadding="0" cellspacing="2" class="border">
          ...
          <tr align="center"> 
            <td class="tdbg"> <table width="100%" border="0" cellpadding="0" cellspacing="2">
                ...
                <tr> 
                  <td width="112" height="22" align="right" >名称：</td>
                  <td width="596" > <input name="title" type="text"
           id="Title2" size="50">
				...
				<tr> 
                  <td width="112" height="22" align="right" >内容：</td>
                  <td width="596" > <textarea name="content" style="width:800px;height:400px;visibility:hidden;"></textarea> 
                  <font color="#FF0000">*</font></td>
                </tr>

                <tr> 
                  <td width="112" height="22" align="right" >录入时间：</td>
                  <td ><input name="UpdateTime" type="text" id="UpdateTime" value="<? echo date('Y-m-d H:i:s')?>" maxlength="50">                    
